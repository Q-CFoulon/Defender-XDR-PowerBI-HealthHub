...
export const config: AppConfig = {
  ...
  defenderApiBaseUrl: optionalEnv("DEFENDER_API_BASE_URL", "https://api.securitycenter.microsoft.com"),
  defenderScope: optionalEnv("DEFENDER_SCOPE", "https://api.securitycenter.microsoft.com/.default"),
